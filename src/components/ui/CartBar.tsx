          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <h2 className="font-display text-lg text-[#F5EFE6]">
                  Tu pedido — {moduleLabel}
                </h2>
                <button onClick={() => setOpen(false)} aria-label="Cerrar">
                  <X size={20} className="text-[#B8935C]" strokeWidth={2} />
                </button>
              </div>
                ...
                {lines.map((l) => (
                  <div key={l.item.id} className="flex items-center justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-[#D4CCBF]">
                    ...
                    <div className="flex items-center gap-3 rounded-full bg-[#0B0B0C] px-2 py-1">
                      ...
                      <span className="w-4 text-center text-sm font-semibold text-[#F5EFE6]">
                        {l.quantity}
                      </span>
                      <button
              ...
              <input
                ...
                placeholder="Ej. 204"
                inputMode="numeric"
                className="w-full rounded-xl border border-[#0B0B0C] bg-[#0B0B0C] px-4 py-3 text-[#F5EFE6] placeholder-[#D4CCBF]/60 outline-none focus:border-[#B8935C]"
              />

              <div className="mt-5 flex items-center justify-between text-base">
                <span className="text-[#D4CCBF]">Total</span>
                <span className="font-display text-xl text-[#F5EFE6]">
              ...
              <p className="mt-3 text-center text-xs text-[#D4CCBF]">
